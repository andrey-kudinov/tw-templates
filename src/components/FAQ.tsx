    ...
    <section className='mb-32'>
      ...
      <div id='accordionFlushExample'>
        ...
        <div className='rounded-none border border-l-0 border-r-0 border-b-0 border-t-0 border-neutral-200'>
          ...
          >
            <div className='py-4 px-5 text-neutral-500 dark:text-neutral-300'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit optio vitae inventore autem fugiat rerum
              sed laborum. Natus recusandae laboriosam quos pariatur corrupti id dignissimos deserunt, praesentium
              voluptatibus temporibus consequatur non aspernatur laborum rerum nemo dolorem libero inventore provident
              exercitationem sunt totam aperiam. Facere sunt quos commodi obcaecati temporibus alias amet! Quam quisquam
